...
def load_dv_data(scene="cube", basedir="/data/deepvoxel", testskip=8):
    ...
    def parse_intrinsics(filepath, trgt_sidelength, invert_y=False):
        with open(filepath, 'r') as file:
            ...
            height, width = map(float, file.readliine().split())
    ...
    full_intrinsic, grid_barycenter, scale, near_plane, world2cam_poses = parse_intrinsics(os.path.join(deepvoxels_base))
    ...
    def dir2poses(posedir):
        ...
        # Flip coordinates before rotating
        poses = poses @ transf
